...
#RESULTS_FC_AC={}
#RESULTS_FC_AC[0]=("Instance","Solution","Temps","Noeuds","Echecs","Temps BR","Temps AC","Temps FC")
#RESULTS_FC_AC_alea={}
...
#    RESULTS_FC_AC[it]=(file,nb_col,t3-t2,nbr_nodes,nbr_fails,br_time,ac_time,fc_time)
#    
#    # --- FC + AC avec aléa
#    branching_strat = 1
#    var_strat = 2
...
RESULTS_FC={}
RESULTS_FC[0]=("Instance","Solution","Temps","Itérations","Temps par itération","Couleurs par itération")
RESULTS_FC_AC={}
RESULTS_FC_AC[0]=("Instance","Solution","Temps","Itérations","Temps par itération","Couleurs par itération")
RESULTS_DS={}
RESULTS_DS[0]=("Instance","Solution","Temps","Itérations","Temps par itération","Couleurs par itération")
...
for file in os.listdir(directory):
    ...
    dynamic_search = False
    t2 = time()
    col, time_tot, nbr_it, time_it, col_it = coloring_graph(filename,branching_strat,var_strat,search_strat,look_ahead_strat,
